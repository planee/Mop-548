    ...
    public:
        ...
        struct boss_mannorothAI : public BossAI
        {
            ...
            void EnterCombat(Unit* attacker)
            {
                ...
                events.ScheduleEvent(EVENT_FEL_FIRESTORM, 45000);
                events.ScheduleEvent(EVENT_SUMMON_DEBILITATOR, 65000);
                events.ScheduleEvent(EVENT_SUMMON_DEVASTATOR, urand(15000, 18000));
				...
				SetEquipmentSlots(false, 28365, 0, 0);
                DoZoneInCombat();
            ...
            void DoAction(const int32 action)
            {
                ...
                {
                    bVarothen = true;
                    events.ScheduleEvent(EVENT_EMBEDDED_BLADE, 15000);
            ...
            void UpdateAI(const uint32 diff)
            {
				...
				if (me->FindNearestPlayer(100.0f, true) && !bVarothen)
				{
					events.RescheduleEvent(EVENT_FELBLADE, 5000);
					events.RescheduleEvent(EVENT_FEL_FIRESTORM, 45000);
					bVarothen = false;
					bAchieve = false;
				...
				if (me->HealthBelowPct(90) && !bVarothen)
                {
					...
					events.ScheduleEvent(EVENT_FELBLADE, 5000);
					events.ScheduleEvent(EVENT_FEL_FIRESTORM, 45000);
					events.ScheduleEvent(EVENT_SUMMON_DEVASTATOR, 18000);
					events.ScheduleEvent(EVENT_SUMMON_DEBILITATOR_1, 17000);
                    bVarothen = true;
                    bAchieve = true;
                    return;
                } 
				if (me->HealthBelowPct(95) && bVarothen && (phase == 0))
                {
                    phase = 1;
					...
					events.ScheduleEvent(EVENT_FEL_FIRESTORM, 45000);
                    return;
                } else if (me->HealthBelowPct(80) && (phase == 1))
                {
                    phase = 2;
					events.CancelEvent(EVENT_SUMMON_DEVASTATOR);
					events.CancelEvent(EVENT_FEL_FIRESTORM);
                ...
                } else if (me->HealthBelowPct(60) && (phase == 2))
                {
					...
					events.ScheduleEvent(EVENT_FEL_FIRESTORM, 45000);
					return;
                } else if (me->HealthBelowPct(40) && (phase == 3))
                {
					events.CancelEvent(EVENT_FEL_FIRESTORM);
					events.CancelEvent(EVENT_FELBLADE);
                    phase = 4;
				...
				if (uint32 eventId = events.ExecuteEvent())
                {
					...
					case EVENT_MANNOROTH_AGGRO:
						...
						//events.ScheduleEvent(EVENT_MANNOROTH_AGGRO, urand(25000, 35000));
						break;
					case EVENT_FEL_FIRESTORM:
						DoCast(me, SPELL_FEL_FIRESTORM);
						//if (Creature* pCreature = me->FindNearestCreature(NPC_FEL_FLAMES, 150.0f))
							//pCreature->AddAura(SPELL_FEL_FLAMES_AURA, pCreature);
						events.ScheduleEvent(EVENT_FEL_FIRESTORM, urand(40000, 45000));
						break;
					case EVENT_FELBLADE:
						DoCast(me, SPELL_FELBLADE, true);
						if (Unit* pTarget = SelectTarget(SELECT_TARGET_RANDOM, 0, 100.0f, true))
							me->Attack(pTarget, true);
						events.ScheduleEvent(EVENT_FELBLADE, urand(15000, 20000));
						break;
                    ...
                    case EVENT_EMBEDDED_BLADE:
							...
							if (Creature* sword = me->SummonCreature(NPC_VAROTHEN_MAGICAL_BLADE, varothenPos, TEMPSUMMON_MANUAL_DESPAWN, 5000))
								sword->AddAura(SPELL_EMBEDDED_BLADE_2, me);
							    me->AddAura(SPELL_EMBEDDED_BLADE_DUMMY, me);
                    ...
                    case EVENT_EMBEDDED_BLADE_1:
                            ...
                            events.RescheduleEvent(EVENT_FELBLADE, urand(10000, 15000));
                            break;
                    ...
                    case EVENT_INFERNAL:
                            ...
                            events.RescheduleEvent(EVENT_FELBLADE, urand(15000, 20000));
                            events.ScheduleEvent(EVENT_GIFT_OF_SARGERAS_1, 15000);
                            break;
                    ...
                    case EVENT_GIFT_OF_SARGERAS_2:
                            ...
                            events.ScheduleEvent(EVENT_GIFT_OF_SARGERAS_3, 5000);
                            break;
                    ...
                    case EVENT_GIFT_OF_SARGERAS_4:
                            ...
                            events.ScheduleEvent(EVENT_GIFT_OF_SARGERAS_5, 5000);
                            break;
                    case EVENT_GIFT_OF_SARGERAS_5:
                            ...
                            break;
                    case EVENT_DESPAWN:
						    me->SummonGameObject(209541, 3347.73f, -5736.66f, 14.9964f, 4.54f, 4.54f, 4.54f, 4.54f, 4.54f, 20000);
        ...
        private:
            ...
            void CompleteEncounter()
            {
                ...
                if (instance)
                {
                    ...
                    instance->DoModifyPlayerCurrenciesIfLevel(395, 7000, 85);
