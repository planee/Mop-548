...
enum Spells
{
    ...
    SPELL_FROST_BLADES_SUMMON   = 101339, // Summon Frost Blades spell. Use with JustSummoned to send them away in a straight line, otherwise npc works ok.
...
enum Events
{
    ...
    EVENT_BLINK             = 2,  // Every 30 sec.
    EVENT_FROSTBOLT_VOLLEY  = 3, // 3 times in succession after blink.
    EVENT_PYROBLAST         = 4, // Constantly, no melee. Every 5 to 6 sec.
    EVENT_FROST_BLADES      = 5, // 25 sec cd, just after blink.
