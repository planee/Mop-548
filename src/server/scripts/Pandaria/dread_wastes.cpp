...
/*
	NPC Entry 64995 Adjunct Sek_ot
*/
class npc_adjunct_sek_ot : public CreatureScript
{
public:
	npc_adjunct_sek_ot() : CreatureScript("npc_adjunct_sek_ot") { }

	CreatureAI* GetAI(Creature* creature) const
	{
		return new npc_adjunct_sek_otAI(creature);

	}

	struct npc_adjunct_sek_otAI : public ScriptedAI
	{
		npc_adjunct_sek_otAI(Creature* creature) : ScriptedAI(creature)
		{
		...
		{
			EventTimer = 2000;			
			me->AddAura(129419, me);
			me->AddAura(126316, me);
		}

		void SpellHit(Unit* caster, const SpellInfo* pSpell)
		{
			if (pSpell->Id == 128162) // Attraper la flamme
			{
				me->RemoveAura(129419);
				me->RemoveAura(126316);
...
#define GOSSIP_ITEM2 "!Liberar"
/*
NPC Entry 64849 Kunchong Hatchling
*/
class npc_Kunchong_Hatchling : public CreatureScript
{
public:
	npc_Kunchong_Hatchling() : CreatureScript("npc_Kunchong_Hatchling") { }
	...
	struct npc_Kunchong_HatchlingAI : public ScriptedAI
	{
		npc_Kunchong_HatchlingAI(Creature* creature) : ScriptedAI(creature)
		{			
		}
		uint32 EventTimer;
	...
	CreatureAI* GetAI(Creature* creature) const
	{
		return new npc_Kunchong_HatchlingAI(creature);
...
void AddSC_dread_wastes()
{
    ...
    //Quest scripts
	new npc_Kunchong_Hatchling();
	new npc_adjunct_sek_ot();
