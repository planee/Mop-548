...
enum MogushanAchievements
{
    ACHIEVEMENTS_DEFEAT_XIN_NORMAL = 6755,
	ACHIEVEMENTS_DEFEAT_XIN_HEROIC = 6756,
	ACHIEVEMENTS_GLINTROK_N_ROLL = 6478,
	ACHIEVEMENTS_WHAT_DOES_THE_BUTTOM = 6736,
	ACHIEVEMENTS_QUILEN_STATUES = 6713,
};
enum eSpells
{
    //Kuai the brute
	...
	//Quilen Statues Trashs
	SPELL_LEAPING_RUSH = 75002,

	//Quilen Spell for Achieve
	SPELL_SUMMONER_TO_LOOTER        = 123207,
	SPELL_TO_SUMMONER               = 123224,
	SPELL_AURA_TO_ACHIEVE           = 124352,
	...
	//Spell Aura Cosmetics for Achieve
	SPELL_COSMETIC_METEOR           = 99301,
	SPELL_MECHANISM_DEFENSE         = 124527,
	SPELL_BALL_OF_FLAMES_COSMETIC   = 71756,
};
...
enum eCreatures
{
	...
	CREATURE_QUILEN_STATUE                  = 63739,
	NPC_QUILEN_SUMMONER                     = 63091,
	NPC_QUILEN_LOOTED                       = 63092,

    //Trigger
    CREATURE_WHIRLING_DERVISH               = 61626,
    CREATURE_BEACON                         = 64250,
	CREATURE_SCOUT_2                        = 61399,
	TRIGGER_METEOR                          = 14495,
	CRYSTAL_SUMMONER                        = 19916,
	CRYSTAL_SUMMONED_TRIGGER                = 67612,
