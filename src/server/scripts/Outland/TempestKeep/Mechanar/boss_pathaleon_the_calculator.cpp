        ...
        struct boss_pathaleon_the_calculatorAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/) 
            {
				...
				if (me->GetMap()->IsHeroic())
				{
					...
					{
						if (AchievementEntry const* The_MechanarH = sAchievementStore.LookupEntry(679))
							cPlayer->CompletedAchievement(The_MechanarH);
					}					
				...
				if (!me->GetMap()->IsHeroic())
				{
					...
					for (auto cPlayer : PlayerList)
					{
						if (AchievementEntry const* The_Mechanar = sAchievementStore.LookupEntry(658))
							cPlayer->CompletedAchievement(The_Mechanar);
					}
