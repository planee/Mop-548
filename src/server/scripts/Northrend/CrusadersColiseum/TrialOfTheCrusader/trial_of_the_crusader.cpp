...
#define GOSSIP_ITEM		"!!!Teleportame Fuera del Raid!!"
class npc_teleporter_custom : public CreatureScript
{
public:
	npc_teleporter_custom() : CreatureScript("npc_teleporter_custom") { }
	...
	struct npc_teleporter_customAI : public ScriptedAI
	{
		npc_teleporter_customAI(Creature* creature) : ScriptedAI(creature)
		{
	...
	CreatureAI* GetAI(Creature* creature) const
	{
		return new npc_teleporter_customAI(creature);
	}
private:
	float x = 8502.84f;
	float y = 724.707f;
