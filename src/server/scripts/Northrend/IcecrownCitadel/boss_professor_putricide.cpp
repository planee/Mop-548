...
/*Spell que Summonea al la aberracion */
...
class go_bevimi : public GameObjectScript
{
public:
	go_bevimi() : GameObjectScript("go_bevimi") { }

	

	bool OnGossipHello(Player* player, GameObject* go)
	{
		player->CastSpell(player, 70308);
		return true;
	}
};
