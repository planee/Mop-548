            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_WAIL_OF_SOULS:
                        ...
                        events.RescheduleEvent(EVENT_WAIL_OF_SOULS, 1000);
                        return;
                }
            }
            DoMeleeAttackIfReady();
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_UNHOLY_RAGE:
                        ...
                        events.RescheduleEvent(EVENT_UNHOLY_RAGE, 1000);
                        return;
                }
            }
            DoMeleeAttackIfReady();
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_SHADOW_LANCE:
                        ...
                        events.RescheduleEvent(EVENT_SHADOW_LANCE, 3000);
                        return;
                }
            }
...
public:
    ...
    struct mob_soulguard_bonecasterAI: public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            events.ScheduleEvent(EVENT_RAISE_DEAD, 15000);
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_RAISE_DEAD:
                        ...
                        events.RescheduleEvent(EVENT_RAISE_DEAD, 15000);
                        return;
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_SOUL_STRIKE:
                        ...
                        events.RescheduleEvent(EVENT_SOUL_STRIKE, 2000);
                        return;
                }
            }
