...
static const Position outroPos[9] =
{
	...
	{1016.0930f, 170.5858f, 643.4134f, 0.0000000f},	// Tyrannus Combat Start Position (Add by Katzu)
};
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SPECIAL:
                            ...
                            events.ScheduleEvent(EVENT_SPECIAL, urand(10000, 15000));
                            break;
                ...
                while (uint32 eventId = _events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_OUTRO_12:
                            ...
                            _events.ScheduleEvent(EVENT_OUTRO_13, 4000);
                            break;
                        case EVENT_OUTRO_13:
                            if (Creature* jainaOrSylvanas = ObjectAccessor::GetCreature(*me, _outroNpcGUID))
                            {
                            ...
                            _events.ScheduleEvent(EVENT_OUTRO_END, 45000);
                            if (Creature* tyrannus = ObjectAccessor::GetCreature(*me, _tyrannusGUID))
                                tyrannus->GetMotionMaster()->MovePoint(0, outroPos[8]);
                            break;
