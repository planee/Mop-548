        ...
        struct boss_tyrannusAI : public BossAI
        {
            ...
            void JustDied(Unit* /*killer*/)
            {
				...
				if (instance)
				{
					...
					instance->DoCompleteAchievement(ACHIEV_PIT_OF_SARON_N);
					if (IsHeroic())
					{
						instance->DoModifyPlayerCurrenciesIfLevel(395, 5000, 80);
					}
				}
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_COMBAT_START:
                            ...
                            DoZoneInCombat();
                            events.ScheduleEvent(EVENT_OVERLORD_BRAND, urand(2000, 4000));
                            events.ScheduleEvent(EVENT_FORCEFUL_SMASH, urand(5000, 7000));
                            events.ScheduleEvent(EVENT_MARK_OF_RIMEFANG, urand(10000, 12000));
                            break;
                        ...
                        case EVENT_UNHOLY_POWER:
                            ...
                            events.ScheduleEvent(EVENT_FORCEFUL_SMASH, urand(10000, 18000));
                            break;
                        case EVENT_MARK_OF_RIMEFANG:
                            ...
                            events.ScheduleEvent(EVENT_MARK_OF_RIMEFANG, urand(18000, 22000));
                            break;
                    }
                }
