...
enum Spells
{
	...
	SPELL_DARKNESS_OF_A_THOUSAND_SOULS_DAMAGE	= 99859, // Originally 45657  Reemplazed with a 16k Damage due to errors
    ...
    struct boss_kiljaedenAI : public Scripted_NoMovementAI
    {
        ...
        void JustDied(Unit* /*killer*/)
        {
			...
			if (instance)
			{
				...
				instance->DoAddTitleIfLevel(53 /* Champion of the Naauru, 70 */, 70 /* Lv 70 to Obtain it */);
			}
        }
