...
public:
	...
	struct npc_neptulonAI : public ScriptedAI
	{
		...
		void CompleteEncounter()
		{
			...
			{
				pInstance->DoModifyPlayerCurrenciesIfLevel(395, 5000, 85);
				GameObject* Chest = me->SummonGameObject(GO_NEPTULON_CACHE_H, -148.195f, 1022.966f, 231.49f, 4.79f, 0, 0, 0, 0, 90000000);
				Chest->SetRespawnTime(Chest->GetRespawnDelay());
			}
			else
			{
				GameObject* Chest = me->SummonGameObject(GO_NEPTULON_CACHE, -148.195f, 1022.966f, 231.49f, 4.79f, 0, 0, 0, 0, 90000000);
				Chest->SetRespawnTime(Chest->GetRespawnDelay());
			}
			EnterEvadeMode();
		}
