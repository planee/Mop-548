...
int Master::Run()
{
	...
	sLog->outInfo(LOG_FILTER_SERVER_LOADING, "  ______  ______  ______");
	sLog->outInfo(LOG_FILTER_SERVER_LOADING, " /\\  == \\/\\  _  \\/\\  ___\\");
	sLog->outInfo(LOG_FILTER_SERVER_LOADING, " \\ \\  __<\\ \\ \\_\\ \\ \\ \\_==\\");
	sLog->outInfo(LOG_FILTER_SERVER_LOADING, "  \\ \\_\\ \\_\\ \\_____\\ \\_____\\");
	sLog->outInfo(LOG_FILTER_SERVER_LOADING, "   \\/_/\\/_/\\/_____/\\/_____/");
