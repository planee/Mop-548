...
class Log
{
    ...
    public:
		...
		void outGMCommand(uint32 account, const char * str, ...) ATTR_PRINTF(3, 4);
		...
		void SetSpecialLogStatus(bool status) { m_SpecialLogStatus = status; }
		bool GetSpecialLogStatus() { m_SpecialLogStatus; }
