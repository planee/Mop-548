...
template<class Check>
void WoWSource::AreaTriggerListSearcher<Check>::Visit(AreaTriggerMapType& p_AreaTriggerMap)
{
...
template<class Check>
void WoWSource::AreaTriggerSearcher<Check>::Visit(AreaTriggerMapType& p_AreatriggerMap)
{
    // already found
    if (i_object)
        return;
