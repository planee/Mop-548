...
struct LootItem
{
    ...
    explicit LootItem(LootStoreItem const& li, Loot* loot, bool extraItems = false);
...
class LootTemplate
{
    ...
    public:
        ...
        void Process(Loot& loot, bool rate, uint16 lootMode, uint8 groupId = 0, Player* looter = NULL) const;
...
struct Loot
{
    ...
    void AddItem(LootStoreItem const & item, Player* looter = NULL, bool extraItems = false);
