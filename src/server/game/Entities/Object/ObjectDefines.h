...
GUID_TRAIT_GLOBAL(HighGuid::HIGHGUID_PLAYER)
GUID_TRAIT_GLOBAL(HighGuid::HIGHGUID_ITEM)
GUID_TRAIT_GLOBAL(HighGuid::HIGHGUID_TRANSPORT)
GUID_TRAIT_GLOBAL(HighGuid::HIGHGUID_GROUP)
GUID_TRAIT_GLOBAL(HighGuid::HIGHGUID_GUILD)
GUID_TRAIT_GLOBAL(HighGuid::HIGHGUID_INSTANCE_SAVE)
GUID_TRAIT_GLOBAL(HighGuid::HIGHGUID_TYPE_BATTLEGROUND)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_MO_TRANSPORT)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_UNIT)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_AREATRIGGER)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_VEHICLE)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_PET)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_GAMEOBJECT)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_DYNAMICOBJECT)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_CORPSE)
GUID_TRAIT_MAP_SPECIFIC(HighGuid::HIGHGUID_SCENEOBJET)
