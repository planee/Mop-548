...
class Minion : public TempSummon
{
    public:
		...
		BattlePet::PetTemplate* GetBattlePetTemplate()
		{
			return m_BattlePetTemplate;
		}


		BattlePet::PetTemplate* CreateBattlePet();		
		void InitialBattlePet(BattlePet::PetTemplate* proto, uint64 const creatorGuid);
    protected:
        Unit* const m_owner;
        float m_followAngle;
	private:
		BattlePet::PetTemplate* m_BattlePetTemplate;
		bool m_isBattlePetCreated;
};
