...
enum WintergraspNpcs
{
    ...
    BATTLEFIELD_WG_NPC_STONE_GUARD_MUKAR            = 30739, // <WINTERGRASP QUARTERMASTER> !! IMPORTANT!!! entry replaced by guards entry, ORIGINAL: [32296]
    BATTLEFIELD_WG_NPC_HOODOO_MASTER_FU_JIN         = 31101, // <MASTER HEXXER>
    BATTLEFIELD_WG_NPC_CHAMPION_ROS_SLAI            = 30739, // <WINTERGRASP QUARTERMASTER> !! IMPORTANT!!! entry replaced by guards entry, ORIGINAL: [39173]
    ...
    BATTLEFIELD_WG_NPC_KNIGHT_DAMERON               = 30740, // <WINTERGRASP QUARTERMASTER> !! IMPORTANT!!! entry replaced by guards entry, ORIGINAL: [32294]
    BATTLEFIELD_WG_NPC_SORCERESS_KAYLANA            = 31051, // <ENCHANTRESS>
    BATTLEFIELD_WG_NPC_MARSHAL_MAGRUDER             = 30740, // <WINTERGRASP QUARTERMASTER> !! IMPORTANT!!! entry replaced by guards entry, ORIGINAL: [39172]
