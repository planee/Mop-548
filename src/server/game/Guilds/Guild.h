...
class Guild
{
    ...
    public:
		...
		void SendGuildChallengeUpdated(WorldSession* p_Session = nullptr);
    ...
    protected:
		...
		std::vector<int32> m_ChallengeCount;
    ...
    private:
        ...
        void SendGuildNewLeader(Member* newLeader, Member* oldLeader);
