...
enum AchievementCriteriaTypes
{
    ...
    ACHIEVEMENT_CRITERIA_TYPE_SCENARIOS_COMPLETED           = 151, // - NYI
    ACHIEVEMENT_CRITERIA_TYPE_COMPLETE_SCENARIO_ID          = 152, // - NYI
    ACHIEVEMENT_CRITERIA_TYPE_UNK153                        = 153, // - Not used
    ACHIEVEMENT_CRITERIA_TYPE_CAPTURE_SPECIFIC_BATTLEPET    = 155, // 
    ACHIEVEMENT_CRITERIA_TYPE_EARN_BATTLEPET                = 156, // 
    ACHIEVEMENT_CRITERIA_TYPE_CAPTURE_BATTLEPET_IN_COMBAT   = 157, // 
    ACHIEVEMENT_CRITERIA_TYPE_WIN_PETBATTLE                 = 158, // - NYI
    ACHIEVEMENT_CRITERIA_TYPE_UNK159                        = 159, // - Not used
    ACHIEVEMENT_CRITERIA_TYPE_LEVELUP_BATTLEPET             = 160, // 
    ACHIEVEMENT_CRITERIA_TYPE_CAPTURE_BATTLEPET_IN_ZONE     = 161, // 
    ACHIEVEMENT_CRITERIA_TYPE_UNK162                        = 162, // - Not used
    ACHIEVEMENT_CRITERIA_TYPE_PLACE_WORK_ORDER              = 163, // NYI
    ACHIEVEMENT_CRITERIA_TYPE_TOTAL                         = 164
};
