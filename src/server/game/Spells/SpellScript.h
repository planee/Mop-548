...
enum SpellScriptHookType
{
	...
	SPELL_SCRIPT_HOOK_PREPARE_CAST,
...
class SpellScript : public _SpellScript
{
    ...
    public:
		...
		HookList<CastHandler> OnPrepareCast;
...
enum AuraScriptHookType
{
    ...
    AURA_SCRIPT_HOOK_EFFECT_MASTERY_UPDATE,
...
class AuraScript : public _SpellScript
{
    ...
    #define AURASCRIPT_FUNCTION_TYPE_DEFINES(CLASSNAME) \
        ...
        typedef void(CLASSNAME::*AuraEffectMasteryUpdateFnType)(AuraEffectPtr); \
        ...
        class EffectMasteryUpdateHandler : public EffectBase
        {
            public:
                EffectMasteryUpdateHandler(AuraEffectMasteryUpdateFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName);
                void Call(AuraScript* auraScript, AuraEffectPtr aurEff);
            private:
                AuraEffectMasteryUpdateFnType pEffectHandlerScript;
        };
        ...
        class EffectMasteryUpdateHandlerFunction : public AuraScript::EffectMasteryUpdateHandler { public: EffectMasteryUpdateHandlerFunction(AuraEffectMasteryUpdateFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName) : AuraScript::EffectMasteryUpdateHandler((AuraScript::AuraEffectMasteryUpdateFnType)_pEffectHandlerScript, _effIndex, _effName) {} }; \
    ...
    public:
        ...
        // executed when mastery aura effect is updated
        // example: OnEffectMasteryUpdate += AuraEffectMasteryUpdateFn(class::function, EffectIndexSpecifier, EffectAuraNameSpecifier);
        // where function is: void function (AuraEffectPtr aurEff);
        HookList<EffectMasteryUpdateHandler> OnEffectMasteryUpdate;
        #define AuraEffectMasteryUpdateFn(F, I, N) EffectMasteryUpdateHandlerFunction(&F, I, N)
