...
class AuraEffect : public std::enable_shared_from_this<AuraEffect>
{
    ...
    public:
		...
		bool HasSpellClassMask() const { return m_spellInfo->Effects[m_effIndex].SpellClassMask != flag128(0) ? true : false; }
		bool HasSpellClassMaskSafe() const;
    ...
    public:
        ...
        void HandleAuraModIncreaseManaRegen(AuraApplication const* aurApp, uint8 mode, bool /*apply*/) const;
        ...
        void HandleAuraModPetStatPctFromMax(AuraApplication const* aurApp, uint8 mode, bool apply) const;
        //   fight
		...
		void HandleAuraModSpellHaste(AuraApplication const* aurApp, uint8 mode, bool apply) const;
