...
enum AuraType
{
    ...
    SPELL_AURA_OVERRIDE_AUTO_ATTACKS_BY_SPELL               = 367,  
    ...
    SPELL_AURA_MOD_CURRENCY_GAIN_2                          = 376,  
    SPELL_AURA_ALLOW_ALL_CASTS_WHILE_WALKING                = 377,  
    SPELL_AURA_378                                          = 378,  // 5.0.5 unk aura
    SPELL_AURA_INCREASE_MANA_REGEN                          = 379,  // SPELL_AURA_INCREASE_MANA_REGEN
    SPELL_AURA_380                                          = 380,  // 5.0.5 unk aura
    SPELL_AURA_INCREASE_HEALTH_FROM_OWNER                   = 381,  
    SPELL_AURA_MOD_PET_STAT_PCT_FROM_MAX                    = 382,  // SPELL_AURA_MOD_PET_STAT_PCT_FROM_MAX
    ...
    SPELL_AURA_MOD_COOLDOWN_BY_MELEE_HASTE                  = 416,  // SPELL_AURA_MOD_COOLDOWN_BY_MELEE_HASTE
    SPELL_AURA_MOD_GLOBAL_COOLDOWN_BY_MELEE_HASTE           = 417,  // SPELL_AURA_REDUCE_GLOBAL_COOLDOWN, affected by Haste, check 158836, 154555. 5.0.5. NYI.
