...
AuraScript::EffectMasteryUpdateHandler::EffectMasteryUpdateHandler(AuraEffectMasteryUpdateFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName)
: AuraScript::EffectBase(_effIndex, _effName)
{
    pEffectHandlerScript = _pEffectHandlerScript;
}

void AuraScript::EffectMasteryUpdateHandler::Call(AuraScript* auraScript, AuraEffectPtr aurEff)
{
    (auraScript->*pEffectHandlerScript)(aurEff);
}
