...
enum SpellTargetSelectionCategories
{
    ...
    TARGET_SELECT_CATEGORY_PROYECTILE,
};
...
enum SpellCustomAttributes
{
    ...
    SPELL_ATTR0_CU_UPDATE_LAST_TICK              = 0x00800000,  // Save and update last tick after refreshing
    ...
    SPELL_ATTR0_CU_USABLE_WHILE_SLEEPED          = 0x08000000,
...
public:
    ...
    int32 CalcValue(Unit const* caster = NULL, int32 const* basePoints = NULL, Unit const* target = NULL, Item const* itemTarget = NULL, int32 itemLevel = -1) const;
...
public:
	...
	HavocTrigged* const m_havoctrigged = new HavocTrigged();
	void SetTriggeredByHavoc(bool const value) const;
	bool GetTriggeredByHavoc() const{ return  m_havoctrigged->isTrigged; }
    ...
    float GetBonusValueForOldBonus(float defaultValue) const;
