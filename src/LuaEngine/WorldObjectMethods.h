...
namespace LuaWorldObject
{
    ...
    int GetNearestPlayer(lua_State* L, WorldObject* obj)
    {
        ...
        WoWSource::PlayerLastSearcher<Eluna::WorldObjectInRangeCheck> searcher(obj, target, checker);
    ...
    int GetNearestGameObject(lua_State* L, WorldObject* obj)
    {
        ...
        WoWSource::GameObjectLastSearcher<Eluna::WorldObjectInRangeCheck> searcher(obj, target, checker);
    ...
    int GetNearestCreature(lua_State* L, WorldObject* obj)
    {
        ...
        WoWSource::CreatureLastSearcher<Eluna::WorldObjectInRangeCheck> searcher(obj, target, checker);
        obj->VisitNearbyGridObject(range, searcher);
    ...
    int GetPlayersInRange(lua_State* L, WorldObject* obj)
    {
        ...
        WoWSource::PlayerListSearcher<Eluna::WorldObjectInRangeCheck> searcher(obj, list, checker);
    ...
    int GetCreaturesInRange(lua_State* L, WorldObject* obj)
    {
        ...
        WoWSource::CreatureListSearcher<Eluna::WorldObjectInRangeCheck> searcher(obj, list, checker);
        obj->VisitNearbyGridObject(range, searcher);
    ...
    int GetGameObjectsInRange(lua_State* L, WorldObject* obj)
    {
        ...
        WoWSource::GameObjectListSearcher<Eluna::WorldObjectInRangeCheck> searcher(obj, list, checker);
        obj->VisitNearbyGridObject(range, searcher);
